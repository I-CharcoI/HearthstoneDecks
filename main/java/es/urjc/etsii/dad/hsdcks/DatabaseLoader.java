...
public class DatabaseLoader {
	...
	private void initDatabase() {
		...
		cartasRep.save(new Cartas("Sacrificio pactado","Brujo","Basico",0,"Destruye a un demonio. Restaura 5 de salud a tu héroe","Basica","Hechizo",0,0,"/imagenes/ImagenesCartas/brujo/sacrificioPactado.jpg"));
		cartasRep.save(new Cartas("Diablillo de llamas","Brujo","Clasico",1,"Grito de batalla: Inflinge 3 de daño a tu héroe","Común","Esbirro",3,2,"/imagenes/ImagenesCartas/brujo/diablilloDeLlamas.jpg"));
		cartasRep.save(new Cartas("Fuego demoníaco","Brujo","Clasico",2,"Inflige 2 de daño. Si el objetivo es un demonio amistoso, en lugar de dañarlo le otorga +2/+2","Común","Hechizo",0,0,"/imagenes/ImagenesCartas/brujo/fuegoDemoniaco.jpg"));
		cartasRep.save(new Cartas("Llama de las sombras","Brujo","Clasico",4,"Destruye un esbirro amistoso e inflinge un daño equivalente a su ataque a todos los esbirros enemigos","Poco común","Hechizo",0,0,"/imagenes/ImagenesCartas/brujo/llamaDeLasSombras.jpg"));
		...
		cartasRep.save(new Cartas("Vacío abisal","Brujo","Clasico",8,"Destruye a todos los esbirros","Épica","Hechizo",0,0,"/imagenes/ImagenesCartas/brujo/vacioAbisal.jpg"));
