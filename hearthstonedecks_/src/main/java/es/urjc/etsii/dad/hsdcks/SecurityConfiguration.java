...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/mazo").permitAll();
		...
		http.authorizeRequests().antMatchers("/publicarN").hasAnyRole("ADMIN");
		//Publicar una nueva carta lo relaiza solamente el admin
		http.authorizeRequests().antMatchers("/nuevaCarta").hasAnyRole("ADMIN");
